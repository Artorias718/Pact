...
@PactTestFor(providerName = "SystemLabelsAddProvider", port = "8080")
public class SystemLabelsAddConsumerTest extends UsersTestBase {
    ...
    @Pact(provider = "SystemLabelsAddProvider", consumer = "SystemLabelsAddConsumer")
    public RequestResponsePact createPact(PactDslWithProvider builder) {
        PactDslResponse getLanguagesResponse = buildGetLanguages(builder, 1,10);
        PactDslResponse postLabelsResponse = buildPostLabel(getLanguagesResponse);
        PactDslResponse getLabelsResponse = buildGetLabels(postLabelsResponse,1,10);
        return getLabelsResponse.toPact();
    }
    ...
    private PactDslResponse buildPostLabel(PactDslResponse builder) {
        PactDslRequestWithPath optionsRequest = builder
                .uponReceiving("The label OPTIONS Interaction")
        ...
        PactDslRequestWithPath request = optionsResponse
                .uponReceiving("The label POST Interaction")
                .path("/entando/api/labels")
                .method("POST");

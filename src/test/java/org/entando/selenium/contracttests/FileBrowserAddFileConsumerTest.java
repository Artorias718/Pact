...
@PactTestFor(providerName = "FileBrowserAddFileProvider", port = "8080")
public class FileBrowserAddFileConsumerTest extends UsersTestBase {
    ...
    @Pact(provider = "FileBrowserAddFileProvider", consumer = "FileBrowserAddFileConsumer")
    public RequestResponsePact createPact(PactDslWithProvider builder) {
        PactDslResponse getDirectoryResponse = buildGetDirectory(builder, "false");
        PactDslResponse postFileResponse = buildPostFile(getDirectoryResponse);
        PactDslResponse getFileBrowserListResponse = buildGetFileBrowserList(postFileResponse);
        PactDslResponse getCurrentPathResponse = buildGetPath(getFileBrowserListResponse,"false", "/pactFile.txt");
        return getCurrentPathResponse.toPact();
    }
    ...
    private PactDslResponse buildPostFile(PactDslResponse builder) {
        PactDslRequestWithPath optionsRequest = builder
                .uponReceiving("The file post OPTIONS Interaction")
                .path("/entando/api/fileBrowser/file")
                .method("OPTIONS")
                .headers("Access-control-request-method", "PUT")
                .body("");
        PactDslResponse optionsResponse = optionsResponse(optionsRequest);
        PactDslRequestWithPath request = optionsResponse
                .uponReceiving("The file POST Interaction")
                .path("/entando/api/fileBrowser/file")
                .method("PUT");
    ...
    private PactDslResponse buildGetPath(PactDslResponse builder, String protectedFolder, String currentPath) {
        PactDslRequestWithPath optionsRequest = builder
                .uponReceiving("The file path OPTIONS Interaction")
                .path("/entando/api/fileBrowser/file")
                .method("OPTIONS")
                .matchQuery("protectedFolder", "\\w+", "" + protectedFolder)
        ...
        PactDslResponse optionsResponse = optionsResponse(optionsRequest);
        PactDslRequestWithPath request = optionsResponse
                .uponReceiving("The file path GET Interaction")
                .path("/entando/api/fileBrowser/file")
                .method("GET")
                .matchQuery("protectedFolder", "\\w+", "" + protectedFolder)
                .matchQuery("currentPath", currentPath);

...
@PactTestFor(providerName = "UserProfileTypeEditProvider", port = "8080")
public class UserProfileTypesEditConsumerTest extends UsersTestBase {
    ...
    */
    ...
    @Pact(provider = "UserProfileTypeEditProvider", consumer = "UserProfileTypeEditConsumer")

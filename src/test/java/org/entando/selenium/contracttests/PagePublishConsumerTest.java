...
@PactTestFor(providerName = "PagePublishProvider", port = "8080")
public class PagePublishConsumerTest extends UsersTestBase {
    ...
    @Pact(provider = "PagePublishProvider", consumer = "PagePublishConsumer")
    public RequestResponsePact createPact(PactDslWithProvider builder) {
        PactDslResponse putPageResponse = buildPublishPage(builder);
    ...
    private PactDslResponse buildPublishPage(PactDslWithProvider builder) {
        PactDslRequestWithPath optionsRequest = builder
                .uponReceiving("The page publish OPTIONS Interaction")
                .path("/entando/api/pages/pagina4/status")
                .method("OPTIONS")
                .headers("Access-control-request-method", "PUT")
                .body("");
        PactDslResponse optionsResponse = optionsResponse(optionsRequest);
        PactDslRequestWithPath request = optionsResponse
                .uponReceiving("The publish PUT Interaction")
                .path("/entando/api/pages/pagina4/status")
                .method("PUT");
        return standardResponse(request, "{\"payload\":{\"code\":\"pagina4\",\"status\":\"published\",\"displayedInMenu\":true,\"pageModel\":\"entando-page-inspinia\",\"charset\":\"utf-8\",\"contentType\":\"text/html\",\"parentCode\":\"homepage\",\"seo\":false,\"titles\":{\"en\":\"Pagina4\",\"it\":\"Pagina4\"},\"fullTitles\":{\"en\":\"Home / Pagina4\",\"it\":\"Home / Pagina4\"},\"ownerGroup\":\"administrators\",\"joinGroups\":[],\"children\":[],\"position\":3,\"numWidget\":0,\"lastModified\":\"2018-10-12 09:47:56\",\"fullPath\":\"homepage/pagina4\",\"token\":null},\"errors\":[],\"metaData\":{\"status\":\"published\"}}");
    }

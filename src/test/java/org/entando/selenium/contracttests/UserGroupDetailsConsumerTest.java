...
@PactTestFor(providerName = "UserGroupDetailsProvider", port = "8080")
public class UserGroupDetailsConsumerTest extends UsersTestBase {
    ...
    @Pact(provider = "UserGroupDetailsProvider", consumer = "UserGroupDetailsConsumer")
    public RequestResponsePact createPact(PactDslWithProvider builder) {
        PactDslResponse getGroupDetails = buildGetGroupDetails(builder);
        PactDslResponse getGroupToPut = buildGetGroupToPut(getGroupDetails);

...
@PactTestFor(providerName = "FragmentsDeleteProvider", port = "8080")
public class FragmentsDeleteConsumerTest extends UsersTestBase {
    ...
    @Pact(provider = "FragmentsDeleteProvider", consumer = "FragmentsDeleteConsumer")
    public RequestResponsePact createPact(PactDslWithProvider builder) {
        PactDslResponse deleteFragmentsResponse = buildDeleteFragments(builder);
        return deleteFragmentsResponse.toPact();
    }

    private PactDslResponse buildDeleteFragments(PactDslWithProvider builder) {
        PactDslRequestWithPath optionsRequest = builder
                .uponReceiving("The Fragment Delete OPTIONS Interaction")
        ...
        PactDslRequestWithPath request = optionsResponse
                .uponReceiving("The Fragment DELETE Interaction")
                .path("/entando/api/fragments/PCT")
                .method("DELETE");

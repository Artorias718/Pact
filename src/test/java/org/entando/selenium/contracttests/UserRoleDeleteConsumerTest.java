...
@PactTestFor(providerName = "UserRoleDeleteProvider", port = "8080")
public class UserRoleDeleteConsumerTest extends UsersTestBase {
    ...
    @Pact(provider = "UserRoleDeleteProvider", consumer = "UserRoleDeleteConsumer")
    public RequestResponsePact createPact(PactDslWithProvider builder) {
        PactDslResponse deleteRoleResponse = buildDeleteRole(builder);
    ...
    private PactDslResponse buildDeleteRole(PactDslWithProvider builder) {

...
@PactTestFor(providerName = "UserProfileTypeDeleteProvider", port = "8080")
public class UserProfileTypeDeleteConsumerTest extends UsersTestBase {
    ...
    */
    ...
    @Pact(provider = "UserProfileTypeDeleteProvider", consumer = "UserProfileTypeDeleteConsumer")
    public RequestResponsePact createPact(PactDslWithProvider builder) {
        ...
        PactDslResponse deleteProfileTypesResponse = buildDeleteProfileType(getProfileTypesStatusResponse);
        PactDslResponse putProfileTypesForAttributes = buildPutProfileTypeForAttributes(deleteProfileTypesResponse);
    ...
    public static PactDslResponse buildDeleteProfileType(PactDslResponse builder) {
        PactDslRequestWithPath request = builder.
                ...
                .path("/entando/api/profileTypes/PCT")
                .method("DELETE");
        return standardResponse(request, "{\"payload\":{\"code\":\"PCT\"},\"errors\":[],\"metaData\":{}}");
    }

    @Test
    public void runTest() throws InterruptedException {

        String profileTypeName = "pact test pt";
        ...
        sleep(400);
        dTUserProfileTypeAddPage.getSaveButton().click();
        Kebab kebab = dTUserProfileTypePage.getTable().getKebabOnTable(profileTypeName, groupsTableHeaderTitles.get(0), groupsTableHeaderTitles.get(2));

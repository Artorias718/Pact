...
@PactTestFor(providerName = "PageAddProvider", port = "8080")
public class PageAddConsumerTest extends UsersTestBase {
    ...
    @Pact(provider = "PageAddProvider", consumer = "PageAddConsumer")
    public RequestResponsePact createPact(PactDslWithProvider builder) {
        ...
        PactDslResponse postPageResponse = buildPostPage(getLanguagesResponse);
        return postPageResponse.toPact();
    }
    ...
    public void runTest() throws InterruptedException {
        ...
        dTPageAddPage.setCodeField("pct");
        dTPageAddPage.getOwnerGroup().selectByVisibleText("Free Access");
        ExpandableTable table = dTPageAddPage.getTable();
        WebElement row = table.findRowList(branchName, "Page tree").get(0);
        row.click();

...
@PactTestFor(providerName = "DataTypesAddProvider", port = "8080")
public class DataTypesAddConsumerTest extends UsersTestBase {
    ...
    @Pact(provider = "DataTypesAddProvider", consumer = "DataTypesAddConsumer")
    public RequestResponsePact createPact(PactDslWithProvider builder) {
        PactDslResponse postDataTypesResponse = buildPostDataTypes(builder);
        PactDslResponse getDataTypesToPutResponse = buildGetDataTypesToPut(postDataTypesResponse);
    ...
    public static PactDslResponse buildPostDataTypes(PactDslWithProvider builder) {
        ...
        PactDslRequestWithPath request = optionsResponse.
                uponReceiving("The Data Types POST Interaction")
                .path("/entando/api/dataTypes")
                .method("POST");

...
@PactTestFor(providerName = "UserGroupEditProvider", port = "8080")
public class UserGroupEditConsumerTest extends UsersTestBase {
    ...
    @Autowired
    public DTUserGroupAddPage dTUserGroupsAddPage;
    ...
    @Pact(provider = "UserGroupEditProvider", consumer = "UserGroupEditConsumer")
    public RequestResponsePact createPact(PactDslWithProvider builder) {
        PactDslResponse getGroupResponse = buildGetGroups(builder, "name", 1, 10);
        PactDslResponse getGroupToPutResponse = buildGetGroupToPut(getGroupResponse);
        PactDslResponse putGroupResponse = buildPutGroup(getGroupToPutResponse);
        return putGroupResponse.toPact();
    }
    ...
    public static PactDslResponse buildGetGroups(PactDslWithProvider builder, String sort, int page, int pageSize) {
    ...
    public static PactDslResponse buildPutGroup(PactDslResponse builder ){
        PactDslRequestWithPath request = builder.uponReceiving("The group  PUT Interaction")
                .path("/entando/api/groups/unimportant")
                .method("PUT");
        String json = "{\"payload\":[{\"code\":\"unimportant\",\"name\":\"UNIMPORTANT\"}],\"errors\":[],\"metaData\":{\"page\":1,\"pageSize\":10,\"lastPage\":1,\"totalItems\":10,\"sort\":\"code\",\"direction\":\"ASC\",\"filters\":[],\"additionalParams\":{}}}";
        return standardResponse(request, json);
    ...
    public void runTest() throws InterruptedException {
        ...
        String groupName = "UNIMPORTANT";
        Kebab kebab = dTUserGroupsPage.getTable().getKebabOnTable(groupName, groupsTableHeaderTitles.get(0), groupsTableHeaderTitles.get(2));
        kebab.getClickable().click();
        kebab.getAction("Edit").click();
        dTUserGroupEditPage.setName("");
        dTUserGroupsAddPage.getSaveButton().click();
    }
}

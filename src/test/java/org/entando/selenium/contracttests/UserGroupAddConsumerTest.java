...
@PactTestFor(providerName = "UserGroupAddProvider", port = "8080")
public class UserGroupAddConsumerTest extends UsersTestBase {
    ...
    @Pact(provider = "UserGroupAddProvider", consumer = "UserGroupAddConsumer")
    public RequestResponsePact createPact(PactDslWithProvider builder) {
        PactDslResponse postGroupResponse = buildPostGroup(builder);
        PactDslResponse getGroupResponse = buildGetGroups2(postGroupResponse, "name", 1, 10);

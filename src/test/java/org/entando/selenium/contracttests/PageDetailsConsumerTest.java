...
@PactTestFor(providerName = "PageDetailsProvider", port = "8080")
public class PageDetailsConsumerTest extends UsersTestBase {
    ...
    @Pact(provider = "PageDetailsProvider", consumer = "PageDetailsConsumer")
    public RequestResponsePact createPact(PactDslWithProvider builder) {
        PactDslResponse getDetailsPageResponse = buildGetDetailsPage(builder,"draft");
        return getDetailsPageResponse.toPact();
    }
    ...
    private PactDslResponse buildGetDetailsPage(PactDslWithProvider builder, String status) {
        PactDslRequestWithPath optionsRequest = builder
                .uponReceiving("The page details OPTIONS Interaction")
        ...
        PactDslResponse optionsResponse = optionsResponse(optionsRequest);
        PactDslRequestWithPath request = optionsResponse
                .uponReceiving("The page details GET Interaction")
                .path("/entando/api/pages/pagina4")
                .method("GET")
                .matchQuery("status", "\\w+", "" + status)
                ;
